            ...
            <div className="modal-container" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '800px' }}>
                ...
                <form onSubmit={handleSubmit} className="modal-body">
                    ...
                    <div className="form-section">
                        ...
                        <div className="form-group full-width mb-md">
                        ...
                        <div className="form-group full-width mt-md">
                    ...
                    <div className="form-section">
                        ...
                        <div className="form-grid">
                            ...
                            <div className="form-group">
                                <label htmlFor="budget">{t('projects.modal.fields.budget')}</label>
                                <CurrencyInput
                                    id="budget"
                                    name="budget"
                        ...
                        <small className="field-hint mt-sm display-block">
